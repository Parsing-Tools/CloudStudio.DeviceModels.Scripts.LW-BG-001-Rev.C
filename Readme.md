...
# Parsing Script – LW-BG-001 - Rev. C

This **Parsing** script is designed for the **LW-BG-001** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – LW-BG-001 Rev. C

Este script de **Parsing** está diseñado para el modelo **LW-BG-001** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
